...
function Field({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {error && (
        <p className="font-crimson italic text-sm text-rose-deep">{error}</p>
      )}
    </div>
  )
}
    ...
    return (
      <div className="flex flex-col items-center gap-8 text-center py-12 px-6">
        <div className="flex flex-col gap-3">
          ...
          <p className="font-lora italic text-lg text-dark-taupe/90 max-w-md leading-relaxed">
        ...
        <div className="flex flex-col items-center gap-3 w-full max-w-xs">
          ...
          <a
            ...
            className="w-full font-work-sans text-[12px] tracking-[0.18em] uppercase px-6 py-3 border border-gold-line/50 text-dark-taupe hover:bg-blush transition-colors duration-200 text-center"
          >
            Google Calendar
          </a>
          <a
          ...
          <button
            onClick={downloadICS}
            className="w-full font-work-sans text-[12px] tracking-[0.18em] uppercase px-6 py-3 border border-gold-line/50 text-dark-taupe hover:bg-blush transition-colors duration-200"
          >
            Apple Calendar (iCal)
          </button>
        </div>
    ...
    >
      ...
      <div className="flex flex-col gap-6">
        ...
        <Field
          ...
          optional
        >
          <p className="font-crimson italic text-base text-rose-deep">Children are warmly welcome.</p>
          <input
        ...
        <div className="flex flex-col gap-3">
          <p className="font-work-sans text-xs sm:text-[13px] tracking-[0.12em] uppercase text-dark-taupe/90 font-medium">
          ...
          <p className="font-crimson text-base text-dark-taupe/90 leading-relaxed">
            ...
            <span className="italic text-rose-deep">(No commitment; we&apos;ll follow up with details.)</span>
          </p>
          <label className="flex items-center gap-3 cursor-pointer mt-1 min-h-[44px]">
            <input
              {...register('hotelBlockInterest')}
              type="checkbox"
              className="w-5 h-5 border border-gold-line/60 accent-gold-deep cursor-pointer"
            />
